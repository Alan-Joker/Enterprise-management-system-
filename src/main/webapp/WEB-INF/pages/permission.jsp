						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/role/role-add'">
							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting_asc">权限名</th>
										<th class="sorting_desc">URL</th>
									</tr>
								</thead>
								<tbody>

									<c:forEach items="${permission}" var="user">
										<tr>
