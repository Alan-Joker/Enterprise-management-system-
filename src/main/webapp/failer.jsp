			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown user user-menu"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"> <img
						src="${pageContext.request.contextPath}/static/img/user2-160x160.jpg"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							...
							<div class="pull-right">
								<a href="${pageContext.request.contextPath}/static/logout.do"
	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${pageContext.request.contextPath}/static/img/user2-160x160.jpg"
		...
		<ul class="sidebar-menu">
			...
			<li id="admin-index"><a
				href="${pageContext.request.contextPath}/static/pages/main.jsp"><i
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
				...
				<ul class="treeview-menu">
					...
					<li id="system-setting"><a
						href="${pageContext.request.contextPath}/static/user/findAll.do"> <i
